  ...
  return (
    <section id="contact" className="sec">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col justify-center">
                <div className="">
                    <h2 className="headline-2 up max-w-[50ch] lg:max-w-[20rem]">Contact me for collaboration</h2>
                    <p className="text-zinc-400 up mt-3 mb-4 max-w-[50ch] lg:max-w-[30ch] " >Reach out today to discuss your project needs and start collaborating on something amazing!</p>
                </div>
                <div className="flex items-center gap-4 mt-4 ">
                    {socialLinks.map(({href, icon},i)=>(
                        <div className="w-12 h-12 up grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-900 active:bg-zinc-50/80 " key={i} >
            ...
            <form action="https://getform.io/f/azylmkjb" method="POST" className="xl:pl-10" >
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        <label htmlFor="name" className="label  up" >
                            Name
                        </label>
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Oussama Boufi" className="text-field up" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="name" className="label  up" >
                            Email
                        </label>
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="oboufi88@gmail.com" className="text-field up" />
                    </div>
                </div>
                    <div className="mb-4">
                        <label htmlFor="message" className="label  up">
                            Message
                        </label>
                        <textarea name="message" id="message" rows="4" required placeholder="Hi!" className="text-field up resize-y w-full min-h-32 max-h-[12rem]" >

                        </textarea>
                    </div>
                
                    <button type="submit" className="btn up btn-primary [&]:max-w-full w-full justify-center " >Send</button>
            </form>
        </div>
    </section>
  )
